...
echo "<table border='1'>";
echo "<tr><th>idTrx</th><th>tglTransaksi</th><th>noTransaksi</th><th>diskon</th><th>totalBayar</th><th>Tunai</th><th>Debit</th><th>Emoney</th><th>kembalian</th><th>ID_Kasir</th></tr>";

while ($row = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)) {
    echo "<tr>";
    echo "<td>" . $row['idTrx'] . "</td>";
    if (isset($row['tglTransaksi'])) {
        echo "<td>" . $row['tglTransaksi']->format('Y-m-d H:i:s') . "</td>";
    } else {
        echo "<td>Not available</td>"; // Or any message you prefer for null values
    }
